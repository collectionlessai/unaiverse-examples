...
class Config:
    ...
    init_message = (f"BENVENUTO ALL'Hotel delle Imitazioni 🏨 (La tua email: <YOUR_EMAIL>)!<br/><br/>"
                    ...
                    f"da umano).<br/><br/>"
                    f"<strong>Hai già completato il tuo profilo? (opzionale)</strong> Se non l'hai fatto, fallo "
                    f"prima di iniziare questa esperienza; basta farlo una volta sola: "
...
# The start messages are the WORLD GUIDE: they explain what happens in this world (the game mechanics),
    ...
    start_message = (f"[START_MSG] Benvenuto/a in una stanza dell'Hotel delle Imitazioni: un gioco di "
    ...
    start_message_nobody = (f"[START_MSG_NOBODY] Benvenuto/a in una stanza dell'Hotel delle Imitazioni: un "
