...
# Agent
processor = LoggerModule(os.path.join(os.path.dirname(os.path.abspath(__file__)), "log", "proc_run_10.log"))
...
# Node hosting agent
node = Node(node_name="Carlos", hosted=agent, hidden=True, clock_delta=1. / 10.)
