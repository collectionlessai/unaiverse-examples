...
class WWorld(World):
    ...
    def create_behav_files(self):
        ...
        behav.add_transit("done_learning", "in_class", action="nop", args={}, ready=False)
        behav.add_transit("done_exam", "in_class", action="nop", args={}, ready=False)
